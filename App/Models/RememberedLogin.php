...
class RememberedLogin extends \Core\Model
{
    ...
    public static function findByToken($token){
        ...
        //dostajemy obiekt klasy z parametrami tj. user_id, expires_at, i token_hash
    ...
    public function getUser(){
        //w metodzie fundByToken zwróciło klasę z parametrem user_id z tabeli remembered_logins
